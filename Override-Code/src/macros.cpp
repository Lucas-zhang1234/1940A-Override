...
void one_pin_macro()
{
    ...
    // Step 5: Lift up pin slightly, and parallel to ground
    position_control::move_absolute_degrees(position_control::MotorId::Lift, 100, 200, 1000);
    position_control::move_absolute_degrees(position_control::MotorId::Wrist, 90, 200, 1000);
}
